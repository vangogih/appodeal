...
namespace Appodeal.Solitaire.Runtime.Core.Game
{
    ...
    /// Creates its <see cref="DealSubSystem"/>, <see cref="RulesSubSystem"/> and
    /// <see cref="UndoSubSystem"/> via direct composition and records reversible changes into the
    /// undo subsystem.
    /// </summary>
    public sealed partial class GameSystem : IGameSystem
    {
        ...
        private readonly IUndoSubSystem _undo = new UndoSubSystem();
