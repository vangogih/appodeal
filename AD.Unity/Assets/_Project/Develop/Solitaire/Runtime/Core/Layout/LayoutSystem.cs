...
namespace Appodeal.Solitaire.Runtime.Core.Layout
{
    ...
    /// the arguments and <see cref="RuntimeConstants.Game.Layout"/>.
    /// </summary>
    public sealed class LayoutSystem : ILayoutSystem
    {
        ...
        public Vector3 GetPilePosition(PileId pile)
        {
            ...
            {
                PileKind.Stock => new Vector3(RuntimeConstants.Game.Layout.StockX, RuntimeConstants.Game.Layout.TopRowY, 0f),
                PileKind.Waste => new Vector3(RuntimeConstants.Game.Layout.WasteX, RuntimeConstants.Game.Layout.TopRowY, 0f),
                PileKind.Foundation => new Vector3(
                    RuntimeConstants.Game.Layout.FoundationStartX + pile.Index * RuntimeConstants.Game.Layout.PileStepX,
                    RuntimeConstants.Game.Layout.TopRowY,
                    0f),
                PileKind.Tableau => new Vector3(
                    RuntimeConstants.Game.Layout.TableauStartX + pile.Index * RuntimeConstants.Game.Layout.PileStepX,
                    RuntimeConstants.Game.Layout.TableauTopY,
                    0f),
                _ => Vector3.zero
            };
        }
